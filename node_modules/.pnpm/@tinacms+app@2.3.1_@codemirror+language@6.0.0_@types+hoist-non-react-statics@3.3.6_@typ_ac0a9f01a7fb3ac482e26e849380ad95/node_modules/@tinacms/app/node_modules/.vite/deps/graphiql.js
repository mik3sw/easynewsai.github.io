...
// node_modules/.pnpm/@graphiql+react@0.18.0_@codemirror+language@6.0.0_@types+react@19.1.8_graphql@15.8.0_re_3f4adb0f7aa9d965bd8944bf32b36889/node_modules/@graphiql/react/dist/index.mjs
...
async function Se5(e4, t18) {
  const n7 = await import("./codemirror.es-4GJURLD3.js").then((r10) => r10.c).then(
    (r10) => (
  ...
  return await Promise.all(
    (t18 == null ? void 0 : t18.useCommonAddons) === false ? e4 : [
      import("./show-hint.es-PNRNHQJB.js").then((r10) => r10.s),
      import("./matchbrackets.es-JPAHCHK5.js").then((r10) => r10.m),
      import("./closebrackets.es-K2TV4ERK.js").then((r10) => r10.c),
      import("./brace-fold.es-JYEJBMAA.js").then((r10) => r10.b),
      import("./foldgutter.es-D4PUCVNT.js").then((r10) => r10.f),
      import("./lint.es-EBLPWAPA.js").then((r10) => r10.l),
      import("./searchcursor.es-YRVEPHTD.js").then((r10) => r10.s),
      import("./jump-to-line.es-MLQPBDE4.js").then((r10) => r10.j),
      import("./dialog.es-NHYPANEV.js").then((r10) => r10.d),
      // @ts-expect-error
      import("./sublime.es-7FO2A7VN.js").then((r10) => r10.s),
      ...e4
    ]
  ), n7;
}
...
function Ce3({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5([
      // @ts-expect-error
      import("./javascript.es-GSAROIP5.js").then((C7) => C7.j)
    ]).then((C7) => {
      if (!g5)
        return;
...
function se4({
  ...
  (0, import_react93.useEffect)(() => {
    ...
    let A3 = true;
    return Se5([
      import("./comment.es-OO3J3L45.js").then((k3) => k3.c),
      import("./search.es-RTUZDXO5.js").then((k3) => k3.s),
      import("./hint.es-3F2ITQFK.js"),
      import("./lint.es2-V2APWVVS.js"),
      import("./info.es-ZBOTCCHX.js"),
      import("./jump.es-KDUQK5TO.js"),
      import("./mode.es-PU2DDKK5.js")
    ]).then((k3) => {
      if (!A3)
        return;
      D7.current = k3;
...
function me4({
  ...
  return (0, import_react93.useEffect)(() => {
    let C7 = true;
    return Se5([
      import("./hint.es2-VXWLF4WN.js"),
      import("./lint.es3-OUBFHBQP.js"),
      import("./mode.es2-5HDZSWCJ.js")
    ]).then((d16) => {
      if (!C7)
        return;
      g5.current = d16;
...
function it4({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5(
      [
        import("./foldgutter.es-D4PUCVNT.js").then((u13) => u13.f),
        import("./brace-fold.es-JYEJBMAA.js").then((u13) => u13.b),
        import("./dialog.es-NHYPANEV.js").then((u13) => u13.d),
        import("./search.es-RTUZDXO5.js").then((u13) => u13.s),
        import("./searchcursor.es-YRVEPHTD.js").then((u13) => u13.s),
        import("./jump-to-line.es-MLQPBDE4.js").then((u13) => u13.j),
        // @ts-expect-error
        import("./sublime.es-7FO2A7VN.js").then((u13) => u13.s),
        import("./mode.es3-TTUUQJ6N.js"),
        import("./info-addon.es-47YJRFXA.js")
      ],
...
// node_modules/.pnpm/graphiql@3.0.0-alpha.1_@codemirror+language@6.0.0_@types+react@19.1.8_graphql@15.8.0_re_bcb069bd4b4c8c1d38c8eba825a48d4b/node_modules/graphiql/esm/components/GraphiQL.js
