 ...
 */
export declare const getRenderNodeProps: <V extends Value>({ attributes, dangerouslyAllowAttributes, nodeProps, props, type, }: Pick<WithPlatePlugin<V, Value, import("..").PlateEditor<Value>>, "props" | "type"> & {
