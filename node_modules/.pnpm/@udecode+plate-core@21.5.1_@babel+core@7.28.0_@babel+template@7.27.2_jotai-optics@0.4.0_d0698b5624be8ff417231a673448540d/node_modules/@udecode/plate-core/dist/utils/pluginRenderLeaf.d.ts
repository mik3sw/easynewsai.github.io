 ...
 */
export declare const pluginRenderLeaf: <V extends Value>(editor: PlateEditor<V>, { key, type, component, dangerouslyAllowAttributes, props, }: PlatePlugin<{}, V, PlateEditor<V>>) => RenderLeaf;
