 ...
 */
export declare const pluginRenderElement: <V extends Value>(editor: PlateEditor<V>, { key, type, component: _component, dangerouslyAllowAttributes, props, }: PlatePlugin<{}, V, PlateEditor<V>>) => RenderElement;
