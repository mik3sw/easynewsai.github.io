import { createPluginFactory, createComponentAs, createElementAs, createStore, createAtomStore, SCOPE_ELEMENT, getBlockAbove, getPluginType, isCollapsed, getAboveNode, getNodeString, useElementProps, mergeProps, useElement, useEditorRef, useComposedRef, findNodePath, setNodes, focusEditor, getPointAfter, isUrl, isDefined, select, useHotkeys, getInjectedPlugins, pipeInsertDataQuery, getPluginOptions, insertNodes, someHtmlElement, onKeyDownToggleMark, findHtmlParentElement } from '@udecode/plate-common';
...
import React, { useState, useEffect, useCallback, forwardRef, useLayoutEffect, useRef, useMemo } from 'react';
...
createComponentAs(({
  ...
  return /*#__PURE__*/React.createElement("div", wrapperProps, /*#__PURE__*/React.createElement("div", _extends({}, resizableProps, restProps), handleLeft, children, handleRight));
});
