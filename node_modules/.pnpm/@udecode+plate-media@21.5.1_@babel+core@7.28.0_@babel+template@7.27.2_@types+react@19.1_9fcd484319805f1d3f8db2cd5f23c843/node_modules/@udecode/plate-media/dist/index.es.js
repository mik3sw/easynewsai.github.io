...
import { resizeLengthClamp, useResizeHandleProps } from '@udecode/resizable';
...
const Resizable = createComponentAs(({
  children,
  ...props
}) => {
  const {
